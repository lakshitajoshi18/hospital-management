          ...
          <CardContent className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Contact administrator to change hospital
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-b pb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label
                    htmlFor="patientsAppointed"
                    className="text-sm font-medium"
                  >
                    Total Patients Appointed
                  </Label>
                  <Input
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                📝 All information marked as read-only is managed by the system
                administrator. For any changes to these fields, please contact
                the support team.
              </p>
            </div>
          </CardContent>
