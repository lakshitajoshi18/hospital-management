...
const fieldClassName =
  "h-11 rounded-xl border-cyan-200 bg-white/85 focus-visible:border-cyan-500 focus-visible:ring-cyan-500/30";
...
const PatientForm = ({
  ...
  hospitalId?: number;
    ...
    const defaultState: PatientFormState = {
      ...
      gender: "male",
      age: "",
      hospital: hospitalId ? String(hospitalId) : "",
      address: "",
    };
      ...
      <div className="relative mx-auto w-full max-w-5xl">
        <Card className="rounded-[32px] border border-white/80 bg-white/72 py-0 shadow-[0_28px_90px_rgba(14,116,144,0.12)] backdrop-blur">
          <CardHeader className="rounded-t-[32px] border-b border-cyan-100/80 bg-white/50 py-6">
            ...
            <CardTitle className="pt-2 text-2xl text-slate-950 sm:text-3xl">
              Patient Appointment Form
            </CardTitle>
            <CardDescription className="text-base leading-6 text-slate-600">
              Fill in your details to request treatment support and schedule
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="patient-name" className="text-cyan-900">
                    Name
                  </Label>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="patient-mobile" className="text-cyan-900">
                    Mobile Number
                  </Label>
                  <div className="relative">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="patient-age" className="text-cyan-900">
                    Age
                  </Label>
                  <Input
                    id="patient-age"
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="patient-hospital" className="text-cyan-900">
                    Hospital
                  </Label>
                  <div className="relative">
                    <Hospital className="pointer-events-none absolute left-3 top-1/2 z-10 size-4 -translate-y-1/2 text-cyan-600" />
                    <Select
                    defaultValue={hospitalList.find(h => h.id === hospitalId)?.id ? String(hospitalId) : undefined}
                      value={form.hospital}
                      onValueChange={(value) =>
                    ...
                    >
                      <SelectTrigger
                        id="patient-hospital"
                        className={cn("w-full pl-10", fieldClassName)}
                      >
                        <SelectValue
                          placeholder={
                            isHospitalLoading
                ...
                <div className="space-y-2">
                  ...
                  <Popover>
                    ...
                    <PopoverContent
                      className="w-auto border-cyan-100 bg-white p-0"
                      align="start"
                    >
                      <Calendar
                        mode="single"
              ...
              <div className="space-y-2">
                <Label htmlFor="patient-address" className="text-cyan-900">
                  Address
                </Label>
                <div className="relative">
              ...
              <div className="flex flex-col gap-3 rounded-2xl border border-cyan-100 bg-cyan-50/55 p-3 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-sm text-cyan-800">
                  Submit your request and we will route you to the selected
                  hospital quickly.
                </p>
                <Button
                  type="submit"
